...
public:
    ...
    void setupUi(QWidget *TelaRegistro)
    {
        ...
        pushButton = new QPushButton(TelaRegistro);
        pushButton->setObjectName("pushButton");
        pushButton->setGeometry(QRect(280, 310, 83, 29));
    ...
    void retranslateUi(QWidget *TelaRegistro)
    {
        ...
        pushButton->setText(QCoreApplication::translate("TelaRegistro", "Confimar", nullptr));

...
static constexpr auto qt_meta_stringdata_ZN21TelaCadastrarPacienteE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN21TelaCadastrarPacienteE[] = {
...
Q_CONSTINIT const QMetaObject TelaCadastrarPaciente::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN21TelaCadastrarPacienteE.offsetsAndSizes,
    qt_meta_data_ZN21TelaCadastrarPacienteE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN21TelaCadastrarPacienteE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<TelaCadastrarPaciente, std::true_type>,
...
void TelaCadastrarPaciente::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (TelaCadastrarPaciente::*)();
            if (_q_method_type _q_method = &TelaCadastrarPaciente::voltarRequisitado; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *TelaCadastrarPaciente::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN21TelaCadastrarPacienteE.stringdata0))

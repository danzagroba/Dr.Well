...
static constexpr auto qt_meta_stringdata_ZN21TelaInicialSecretarioE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN21TelaInicialSecretarioE[] = {
...
Q_CONSTINIT const QMetaObject TelaInicialSecretario::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN21TelaInicialSecretarioE.offsetsAndSizes,
    qt_meta_data_ZN21TelaInicialSecretarioE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN21TelaInicialSecretarioE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<TelaInicialSecretario, std::true_type>,
...
void TelaInicialSecretario::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (TelaInicialSecretario::*)();
            if (_q_method_type _q_method = &TelaInicialSecretario::sairRequisitado; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *TelaInicialSecretario::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN21TelaInicialSecretarioE.stringdata0))

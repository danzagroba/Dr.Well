...
template <> constexpr inline auto TelaHistoricoMedico::qt_create_metaobjectdata<qt_meta_tag_ZN19TelaHistoricoMedicoE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<TelaHistoricoMedico, qt_meta_tag_ZN19TelaHistoricoMedicoE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject TelaHistoricoMedico::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19TelaHistoricoMedicoE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19TelaHistoricoMedicoE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN19TelaHistoricoMedicoE_t>.metaTypes,
    nullptr
} };
...
void TelaHistoricoMedico::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (TelaHistoricoMedico::*)()>(_a, &TelaHistoricoMedico::voltarRequisitado, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (TelaHistoricoMedico::*)()>(_a, &TelaHistoricoMedico::abrirRequisitado, 1))
            return;
    }
}
...
void *TelaHistoricoMedico::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19TelaHistoricoMedicoE_t>.strings))

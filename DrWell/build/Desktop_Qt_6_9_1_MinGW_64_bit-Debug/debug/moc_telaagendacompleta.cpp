...
template <> constexpr inline auto TelaAgendaCompleta::qt_create_metaobjectdata<qt_meta_tag_ZN18TelaAgendaCompletaE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'on_lineEditData_editingFinished'
    ...
    return QtMocHelpers::metaObjectData<TelaAgendaCompleta, qt_meta_tag_ZN18TelaAgendaCompletaE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject TelaAgendaCompleta::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN18TelaAgendaCompletaE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN18TelaAgendaCompletaE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN18TelaAgendaCompletaE_t>.metaTypes,
    nullptr
} };
...
void TelaAgendaCompleta::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (TelaAgendaCompleta::*)()>(_a, &TelaAgendaCompleta::voltarRequisitado, 0))
            return;
    }
}
...
void *TelaAgendaCompleta::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN18TelaAgendaCompletaE_t>.strings))
